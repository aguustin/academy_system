...
export function Header(): React.JSX.Element {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between gap-4 border-b border-border bg-background/95 px-8 backdrop-blur-sm">
      <div>{user?.role === 'admin' && <GlobalSearch />}</div>
